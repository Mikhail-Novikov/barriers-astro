    ...
    <label className={`relative border bg-white rounded-2xl p-4 flex flex-col justify-between cursor-pointer ${className} ${isActive ? 'border-grey-900' : 'border-transparent'}`}>
      ...
      <span className="perco-icons flex items-center gap-2">
        ...
        <span className={`text-xl ${isActive ? 'text-cta' : 'text-grey-700'}`}>
          <i className={isActive ? 'perco-icon-radio' : 'perco-icon-no-radio'} />
        </span>
...
export default function Hero7(): JSX.Element {
  ...
  return (
    <section aria-label="Комплектация" className="bg-grey-400 pt-10 md:pt-15 xl:pt-20 pb-10 md:pb-15 lg:pb-20 xl:pb-25">
      <div className="container">
        <div className="flex flex-col gap-8">
          <h2 id="complectation" className="h2">Комплектация</h2>
